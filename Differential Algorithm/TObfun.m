function y=TObfun(ff1,x,cc,m1,N,ml1,ml2,ml3,ml4,measure1,Freference1_obj,mod)
...
if mod==1
    SimMeasure1=(Freference1_obj.*exp(2*1i*x(13)*10^(-2)*2*pi*ff1/cc)).*Hw2;
else
    SimMeasure1=(Freference1_obj.*exp(2*1i*x(16)*10^(-2)*2*pi*ff1/cc)).*Hw2;
end
