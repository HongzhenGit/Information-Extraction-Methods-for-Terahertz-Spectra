function y=SObfun(ff1,x,cc,m1,N,ml1,ml2,ml3,ml4,celiang1,fcankao1obj,mod)
...
if mod==1
    Simceliang1=(fcankao1obj.*exp(2*1i*x(9)*10^(-2)*2*pi*ff1/cc)).*Hw2;
else
    Simceliang1=(fcankao1obj.*exp(2*1i*x(11)*10^(-2)*2*pi*ff1/cc)).*Hw2;
end
for i=1:m1
