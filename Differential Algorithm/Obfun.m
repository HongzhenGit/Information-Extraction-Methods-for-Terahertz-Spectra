...
if mod==1
    if factor==1
        SimMeasure1=(Freference1_obj.*exp(2*1i*x(5)*10^(-2)*2*pi*ff1/cc)).*Hw;
    else
        SimMeasure1=(Freference1_obj.*exp(2*1i*x(7)*10^(-2)*2*pi*ff1/cc)).*Hw;
    end
else
    if factor==1
        SimMeasure1=(Freference1_obj.*exp(2*1i*x(6)*10^(-2)*2*pi*ff1/cc)).*Hw;
    else
        SimMeasure1=(Freference1_obj.*exp(2*1i*x(9)*10^(-2)*2*pi*ff1/cc)).*Hw;
    end
end
